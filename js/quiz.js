...
let score = 0;
//Inicializamos una variable booleana para saber si el usuario ya envió el formulario y no volver a enviarlo
...
quizForm.addEventListener("submit", function(event) {
    ...
    //Verificamos si el formulario ya ha sido enviado
    if (!quizSubmitted) {
        ...
        //Actualizamos la variable booleana
        quizSubmitted = true;
